;;; themer-color-theme-dark-theme.el
...
(deftheme themer-color-theme-dark)
...
(provide-theme 'themer-color-theme-dark)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; themer-color-theme-dark-theme.el ends here